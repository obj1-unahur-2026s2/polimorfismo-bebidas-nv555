...
* **Cianuro**: el cianuro no favorece al rendimiento, sino que el deportista, luego de consumirlo queda como muerto, llenos de abulia y de marasmo. Con cianuro, el rendimiento sera 0 si el peso del deportista es 70 o menos. Si es mas de 70, 1% del peso + la dosis.
...
## Adiciones de la clase del 5/9/2026

Agregar a Pepe, otro voluntario
* Pesa 80.
* Tiene 30 años (Debe cumplir años).
* Se diferencia de Tito en que para calcular su velocidad en que si tiene mas de 30, le resta 10 de velocidad.